 ...
 */
class GueTask extends EventEmitter {
  /**
  ...
  /**
   * startExecution - Handles execution start
   */
  startExecution() {
  ...
  /**
   * endExecution - Handles execute completion
   */
  endExecution() {
    this.executeEndTime = Date.now();
  }
