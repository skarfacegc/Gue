...
runList.push({
    ...
    fn: './bin/gue.js --config test/integration/sampleTests/succeed.guefile.js succeed',
});

runList.push({
    name: 'nested succeed test',
    fn: './bin/gue.js --config test/integration/sampleTests/nestedSucceed.guefile.js'
       + ' succeed',
});

runList.push({
    name: 'nested fail test',
    fn: './bin/gue.js --config test/integration/sampleTests/nestedFail.guefile.js fail',
});
